...
public class CrystalShovelItem extends ShovelItem implements GeoItem {

    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);

    public static final String ID = "crystal_shovel";
    ...
    public boolean mineBlock(@NotNull ItemStack item, @NotNull Level level, @NotNull BlockState blockState,
        ...
        if (entity instanceof ServerPlayer player && !player.isShiftKeyDown() && blockState.is(BlockTags.MINEABLE_WITH_SHOVEL)) {
