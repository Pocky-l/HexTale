...
public class EliteCuttingMachineMenu extends AbstractContainerMenu {
    ...
    private List<EliteCuttingMachineRecipe> recipes = Lists.newArrayList();
    ...
    public final Container container = new SimpleContainer(1) {
        public void setChanged() {
            super.setChanged();
            EliteCuttingMachineMenu.this.slotsChanged(this);
            EliteCuttingMachineMenu.this.slotUpdateListener.run();
        }
    };
    final ResultContainer resultContainer = new ResultContainer();

    public EliteCuttingMachineMenu(int p_40294_, Inventory p_40295_) {
        this(p_40294_, p_40295_, ContainerLevelAccess.NULL);
    }

    public EliteCuttingMachineMenu(int p_40297_, Inventory p_40298_, final ContainerLevelAccess p_40299_) {
        super(ModMenuTypes.ELITE_CUTTING_MACHINE.get(), p_40297_);
        ...
        this.resultSlot = this.addSlot(new Slot(this.resultContainer, 1, 143, 33) {
            ...
            public void onTake(Player p_150672_, ItemStack p_150673_) {
                ...
                EliteCuttingMachineMenu.this.resultContainer.awardUsedRecipes(p_150672_, this.getRelevantItems());
                ItemStack itemstack = EliteCuttingMachineMenu.this.inputSlot.remove(1);
                if (!itemstack.isEmpty()) {
                    EliteCuttingMachineMenu.this.setupResultSlot();
                }

                p_40299_.execute((p_40364_, p_40365_) -> {
                    long l = p_40364_.getGameTime();
                    if (EliteCuttingMachineMenu.this.lastSoundTime != l) {
                        p_40364_.playSound((Player)null, p_40365_, SoundEvents.UI_STONECUTTER_TAKE_RESULT, SoundSource.BLOCKS, 1.0F, 1.0F);
                        EliteCuttingMachineMenu.this.lastSoundTime = l;
                    }
            ...
            private List<ItemStack> getRelevantItems() {
                return List.of(EliteCuttingMachineMenu.this.inputSlot.getItem());
            }
        });
    ...
    public EliteCuttingMachineMenu(int i, Inventory inventory, FriendlyByteBuf friendlyByteBuf) {
    ...
    public List<EliteCuttingMachineRecipe> getRecipes() {
        return this.recipes;
    }
    ...
    public boolean stillValid(Player p_40307_) {
        return stillValid(this.access, p_40307_, ModBlocks.ELITE_CUTTING_MACHINE.get());
    }
    ...
    private void setupRecipeList(Container p_40304_, ItemStack p_40305_) {
        ...
        if (!p_40305_.isEmpty()) {
            this.recipes = this.level.getRecipeManager().getRecipesFor(ModRecipeTypes.ELITE_CUTTING_MACHINE.get(), p_40304_, this.level);
        }
    ...
    void setupResultSlot() {
        if (!this.recipes.isEmpty() && this.isValidRecipeIndex(this.selectedRecipeIndex.get())) {
            EliteCuttingMachineRecipe cuttingMachineRecipe = this.recipes.get(this.selectedRecipeIndex.get());
    ...
    public MenuType<?> getType() {
        return ModMenuTypes.ELITE_CUTTING_MACHINE.get();
    }
    ...
    public ItemStack quickMoveStack(Player p_40328_, int p_40329_) {
        ...
        if (slot != null && slot.hasItem()) {
            ...
            } else if (this.level.getRecipeManager().getRecipeFor(ModRecipeTypes.ELITE_CUTTING_MACHINE.get(), new SimpleContainer(itemstack1), this.level).isPresent()) {
