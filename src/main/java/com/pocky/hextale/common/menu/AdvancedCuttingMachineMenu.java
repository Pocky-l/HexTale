...
public class AdvancedCuttingMachineMenu extends AbstractContainerMenu {
    ...
    private List<AdvancedCuttingMachineRecipe> recipes = Lists.newArrayList();
    ...
    public final Container container = new SimpleContainer(1) {
        public void setChanged() {
            super.setChanged();
            AdvancedCuttingMachineMenu.this.slotsChanged(this);
            AdvancedCuttingMachineMenu.this.slotUpdateListener.run();
        }
    };
    final ResultContainer resultContainer = new ResultContainer();

    public AdvancedCuttingMachineMenu(int p_40294_, Inventory p_40295_) {
    ...
    public AdvancedCuttingMachineMenu(int p_40297_, Inventory p_40298_, final ContainerLevelAccess p_40299_) {
        ...
        this.resultSlot = this.addSlot(new Slot(this.resultContainer, 1, 143, 33) {
            ...
            public void onTake(Player p_150672_, ItemStack p_150673_) {
                ...
                AdvancedCuttingMachineMenu.this.resultContainer.awardUsedRecipes(p_150672_, this.getRelevantItems());
                ItemStack itemstack = AdvancedCuttingMachineMenu.this.inputSlot.remove(1);
                if (!itemstack.isEmpty()) {
                    AdvancedCuttingMachineMenu.this.setupResultSlot();
                }

                p_40299_.execute((p_40364_, p_40365_) -> {
                    long l = p_40364_.getGameTime();
                    if (AdvancedCuttingMachineMenu.this.lastSoundTime != l) {
                        p_40364_.playSound((Player)null, p_40365_, SoundEvents.UI_STONECUTTER_TAKE_RESULT, SoundSource.BLOCKS, 1.0F, 1.0F);
                        AdvancedCuttingMachineMenu.this.lastSoundTime = l;
                    }
            ...
            private List<ItemStack> getRelevantItems() {
                return List.of(AdvancedCuttingMachineMenu.this.inputSlot.getItem());
            }
        });
    ...
    public AdvancedCuttingMachineMenu(int i, Inventory inventory, FriendlyByteBuf friendlyByteBuf) {
    ...
    public List<AdvancedCuttingMachineRecipe> getRecipes() {
        return this.recipes;
    }
    ...
    public boolean stillValid(Player p_40307_) {
        return stillValid(this.access, p_40307_, ModBlocks.ADVANCED_CUTTING_MACHINE.get());
    }
    ...
    private void setupRecipeList(Container p_40304_, ItemStack p_40305_) {
        ...
        if (!p_40305_.isEmpty()) {
            this.recipes = this.level.getRecipeManager().getRecipesFor(ModRecipeTypes.ADVANCED_CUTTING_MACHINE.get(), p_40304_, this.level);
        }
    ...
    void setupResultSlot() {
        if (!this.recipes.isEmpty() && this.isValidRecipeIndex(this.selectedRecipeIndex.get())) {
            AdvancedCuttingMachineRecipe cuttingMachineRecipe = this.recipes.get(this.selectedRecipeIndex.get());
    ...
    public MenuType<?> getType() {
        return ModMenuTypes.ADVANCED_CUTTING_MACHINE.get();
    }
    ...
    public ItemStack quickMoveStack(Player p_40328_, int p_40329_) {
        ...
        if (slot != null && slot.hasItem()) {
            ...
            } else if (this.level.getRecipeManager().getRecipeFor(ModRecipeTypes.ADVANCED_CUTTING_MACHINE.get(), new SimpleContainer(itemstack1), this.level).isPresent()) {
