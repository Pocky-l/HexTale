...
public class EliteCuttingMachineRecipe implements Recipe<Container> {
    ...
    public EliteCuttingMachineRecipe(ResourceLocation p_44478_, String p_44479_, Ingredient p_44480_, ItemStack p_44481_) {
        this(ModRecipeTypes.ELITE_CUTTING_MACHINE.get(), ModRecipeSerializer.ELITE_CUTTING_MACHINE.get(), p_44478_, p_44479_, p_44480_, p_44481_);
    }

    public EliteCuttingMachineRecipe(RecipeType<?> p_44416_, RecipeSerializer<?> p_44417_, ResourceLocation p_44418_, String p_44419_, Ingredient p_44420_, ItemStack p_44421_) {
        this.type = p_44416_;
    ...
    public ItemStack getToastSymbol() {
        return new ItemStack(ModBlocks.ELITE_CUTTING_MACHINE.get());
    }
    ...
    public static class Serializer<T extends EliteCuttingMachineRecipe> implements RecipeSerializer<T> {
        final EliteCuttingMachineRecipe.Serializer.SingleItemMaker<T> factory;

        protected Serializer(EliteCuttingMachineRecipe.Serializer.SingleItemMaker<T> p_44435_) {
        ...
        interface SingleItemMaker<T extends EliteCuttingMachineRecipe> {
