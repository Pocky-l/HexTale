...
public class MasterCuttingMachineRecipe implements Recipe<Container> {
    ...
    public MasterCuttingMachineRecipe(ResourceLocation p_44478_, String p_44479_, Ingredient p_44480_, ItemStack p_44481_) {
        this(ModRecipeTypes.MASTER_CUTTING_MACHINE.get(), ModRecipeSerializer.MASTER_CUTTING_MACHINE.get(), p_44478_, p_44479_, p_44480_, p_44481_);
    }

    public MasterCuttingMachineRecipe(RecipeType<?> p_44416_, RecipeSerializer<?> p_44417_, ResourceLocation p_44418_, String p_44419_, Ingredient p_44420_, ItemStack p_44421_) {
        this.type = p_44416_;
    ...
    public ItemStack getToastSymbol() {
        return new ItemStack(ModBlocks.MASTER_CUTTING_MACHINE.get());
    }
    ...
    public static class Serializer<T extends MasterCuttingMachineRecipe> implements RecipeSerializer<T> {
        final MasterCuttingMachineRecipe.Serializer.SingleItemMaker<T> factory;

        protected Serializer(MasterCuttingMachineRecipe.Serializer.SingleItemMaker<T> p_44435_) {
        ...
        interface SingleItemMaker<T extends MasterCuttingMachineRecipe> {
