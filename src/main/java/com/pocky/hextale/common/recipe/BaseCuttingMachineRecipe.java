...
public class BaseCuttingMachineRecipe implements Recipe<Container> {
    ...
    public BaseCuttingMachineRecipe(ResourceLocation p_44478_, String p_44479_, Ingredient p_44480_, ItemStack p_44481_) {
        this(ModRecipeTypes.BASE_CUTTING_MACHINE.get(), ModRecipeSerializer.BASE_CUTTING_MACHINE.get(), p_44478_, p_44479_, p_44480_, p_44481_);
    }

    public BaseCuttingMachineRecipe(RecipeType<?> p_44416_, RecipeSerializer<?> p_44417_, ResourceLocation p_44418_, String p_44419_, Ingredient p_44420_, ItemStack p_44421_) {
        this.type = p_44416_;
    ...
    public ItemStack getToastSymbol() {
        return new ItemStack(ModBlocks.BASE_CUTTING_MACHINE.get());
    }
    ...
    public static class Serializer<T extends BaseCuttingMachineRecipe> implements RecipeSerializer<T> {
        final BaseCuttingMachineRecipe.Serializer.SingleItemMaker<T> factory;

        protected Serializer(BaseCuttingMachineRecipe.Serializer.SingleItemMaker<T> p_44435_) {
        ...
        interface SingleItemMaker<T extends BaseCuttingMachineRecipe> {
